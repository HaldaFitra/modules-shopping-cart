...
<input type="hidden" name="cart[<?php echo $item['id'];?>][gambar]" value="<?php echo $item['image'];?>" />
<input type="hidden" name="cart[<?php echo $item['id'];?>][description]" value="<?php echo $item['description'];?>" />
<tr>
<td><?php echo $i++; ?></td>
<td><img class="img-responsive" src="<?php echo base_url() . 'assets/images/'.$item['image']; ?>"/></td>
